...
Ce fichier est ensuite compacté avec 7 bits par valeur par `pack7bits.c` encode avec une réduction suplémentaire  de 8.75%. Au final, les données de frames passent de 1843039 à 572587 octets.
