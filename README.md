...
Le taux de compression est très important, on arrive à obtenir sans traitemernt particulier un ficher de moins de 16 bits qui démontre la possibiité matérielle d'avoir cette animation sur des micros 16bits.
...
- la fréquence de certains caractères  est beaucoup pluds  importante que d'autres, on  pourrait en tenir compte 

- condidérer les frames comme une imgage bitmao. voir le script python qui génère un pgm
